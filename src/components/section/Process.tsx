  ...
  return (
    <section className="py-24 px-8 md:px-12 bg-cover bg-center" style={{ backgroundImage: "url('/assets/img/process.png')" }}>
      <div className="max-w-7xl mx-auto">
        <div className="mb-14">
          <div className="flex items-center gap-2 font-body tracking-[0.18em] uppercase text-acid mb-5">
            <span className="w-5 h-px bg-acid text-base" />
            How It Works
          </div>
          <h2
            className="font-display font-black text-[clamp(36px,4vw,60px)] leading-[1.05] tracking-[-0.025em] text-black"
        ...
        >
          {steps.map((s) => (
            <div
              key={s.num}
              className="p-4 sm:p-12 border-r border-b bg-white"
              style={{
                borderColor: "var(--border-color)",
              }}
            >
              <div
                className="font-display font-black text-[72px] leading-none tracking-[-0.04em] mb-6 text-black/15"
              >
                {s.num}
              </div>
              <h3
